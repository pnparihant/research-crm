          ...
          <div className="rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-1.5 sm:col-span-2 sm:max-w-xs">
                <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                  <Badge n={3} /> Designation <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <select name="designation" value={form.designation} onChange={handleChange} required className={selectCls}>
                    <option value="">Select designation</option>
                    <optgroup label="Research Dept">
                      <option>Director of Equity Research</option>
                      <option>Executive Vice President - Institutional Equity Sales</option>
                      <option>Sr Equity Research Analyst</option>
                    ...
                    <optgroup label="Institutional Dept">
                      <option>Head Institutional Equities</option>
                      <option>Institutional Sales Trader</option>
                      <option>Institutional Dealer</option>
                      <option>Institution Client Relationship</option>
                      <option>Insti Backoffice Executive</option>
